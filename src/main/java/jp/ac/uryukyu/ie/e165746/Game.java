...
public class Game extends Cardstock{
    ...
    public void is_joker(int[] A){
        if (A[0] == A[1] && A[0] == A[2] && A[0] == A[3]) {
            ...
            num = 1; //ワンペア
            if (A[0] == 1 && 9 < A[1] && A[1] < A[2] && A[2] < A[3] && A[3] < 14 || 9 < A[0] && A[0] < A[1] && A[1] < A[2] && A[2] < A[3] && A[3] < 14 && B[3]/13<1) {
                num = 9; //ロイヤルストレートフラッシュ
            }else if (B[0]/13 == B[3]/13){
                num = 5; //フラッシュ
            }
        }
        part_check();
    ...
    public void not_joker(int[] A) {
        if (A[0] == A[1] && A[0] == A[2] && A[0] == A[3]) {
            ...
            num = 0; //ノーペア
            if (A[0] == 1 && A[1] == 10 && A[2] == 11 && A[3] == 12 && A[4] == 13 && B[4]/13<1) {
                num = 9; //ロイヤルストレートフラッシュ
            }else if (B[0]/13 == B[4]/13) {
                num = 5; //フラッシュ
            }
        }
        part_check();
